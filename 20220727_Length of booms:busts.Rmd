...
Booms/busts can be between 3 and 9 measurements long. I recoded length of 6 and higher as long (so 6,7,8 or 9) with 2, and below 6 as short (so 3, 4, or 5) with 1, periods with no booms/busts as 0 (variable = length.boom.d or length.bust.d)
